...
namespace entityframework_05_06_23_.Controllers
{
    public class OrderItemsController : Controller
    {
        ...
        public OrderItemsController(SalesContext context)
        {
            _context = context;
        }
        ...
        {
            var salesContext = _context.OrderItems.Include(o => o.Order).Include(o => o.Product);
        ...
        public async Task<IActionResult> Create([Bind("ItemId,OrderId,ProductId,Quantity,ListPrice,Discount")] OrderItem orderItem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ItemId,OrderId,ProductId,Quantity,ListPrice,Discount")] OrderItem orderItem)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'SalesContext.OrderItems'  is null.");
            }
            var orderItem = await _context.OrderItems.FindAsync(id);
            if (orderItem != null)
            {
